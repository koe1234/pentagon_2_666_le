...
unsigned char keyarray[5] = {0xff, 0xff, 0xff, 0xff, 0xff};
unsigned char bit_counter = 0;
unsigned char scan_code = 0;
bool unpush = false;
bool long_scan_code = false;
...
volatile unsigned char m_x;
volatile unsigned char m_y;
